    ...
    private StringBuilder parseCharArray(char[] charArray)
    {
        ...
        for (char ch : charArray) {
            ...
            if (inQuotes) {
                ...
                if (ch == '\r') {
                    if (debug) System.out.println("ParseDataFile : parseCharArray1 inQuotes: In LF");
                    handleLF(curVal);
                    continue;
                }
                else if (ch == '\n') {
                    if (debug) System.out.println("ParseDataFile : parseCharArray2 inQuotes: In CF");
                    handleCF(curVal);
                    continue;
                }
            }
                ...
                if (ch == customQuote) {
                    ...
                    if (debug) System.out.println("ParseDataFile : parseCharArray3 inQuotes: In LF");
                    handleLF(curVal);
                    continue;
                }
                else if (ch == '\n') {
                    if (debug) System.out.println("ParseDataFile : parseCharArray4 inQuotes: parseCharArray : In CF");
                    handleCF(curVal);
                    continue;
                }
                else {
